...
const {
  permitToken: { value: userWithComponents }, permUserId,
} = require('./tokens');
...
const userConfigId = new ObjectId();
const userConfigId2 = new ObjectId();
const user1Id = new ObjectId();
const user2Id = new ObjectId();
const secrets = [new ObjectId(),new ObjectId()]
const secrets2 = [new ObjectId(),new ObjectId()]
...
const virtualComponent5Id = new ObjectId();
const component5Id = new ObjectId();
const componentVersion5Id = new ObjectId();
...
const virtualComponentNoConfig = {
  ...
  versions: [{ id: componentVersiontIdNoConfig, version: '1.0.0' }],
};

const userConfig = {
  _id: userConfigId,
  secretIds: secrets,
  userId: tokens.permitToken.value.sub,
...
const componentConfig3 = {
  ...
  componentVersionId: componentVersionNotDefaultId,
  authClientId: '71efeb5220a6cb9b4c076eae',
  tenant: new ObjectId(),
};
...
/* Private virtual component that has user tenant as owner */
const virtualComponent5 = {
  _id: virtualComponent5Id,
  name: faker.name.firstName(),
  access: 'private',
  owners: [
    {
      id: '60f922418ced69c612df63ff',
      type: 'tenant'
    }
  ],
  tenant: new ObjectId(),
  defaultVersionId: componentVersion5Id,
  versions: [{ id: componentVersion5Id, version: '1.0.0' }],
};
...
const componentVersion5 = {
  _id: componentVersion5Id,
  name: faker.name.firstName(),
  virtualComponentId: virtualComponent5Id,
  componentId: component5Id,
  authorization: {
    authType: 'API_KEY',
  },
  actions: [
...
/* END Private virtual component that has user tenant as owner */
