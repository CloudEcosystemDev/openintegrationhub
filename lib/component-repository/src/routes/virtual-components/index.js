...
module.exports = ({ iam }) => {
  ...
  const GetDefaultComponentsVersion = asyncHandler(
    require('./GetDefaultComponentsVersion')
  );
  ...
  const DeleteComponentVersion = asyncHandler(
    require('./DeleteComponentVersion')
  );
  ...
  router.get('/defaults', GetDefaultComponentsVersion);
  ...
  router.get(
    '/:id/:componentVersionId/triggers/:triggerName',
    loadVirtualComp,
    GetTrigger
  );
